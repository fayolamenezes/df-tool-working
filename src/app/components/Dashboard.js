    ...
    <main className="min-h-screen bg-[var(--bg-panel)] px-4 py-6 sm:px-6 lg:px-8 overflow-x-hidden">
      <div className="mx-auto max-w-[100%] mt-1">
        ...
        <section className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div className="rounded-[14px] border border-[#E7EAF0] bg-[var(--input)] p-4 shadow-sm">
            ...
            <div className="mt-3 text-[11px] text-[#8D96A8]">
              Industry Avg: <span className="font-medium text-[#566072]">{selected?.industryAvgDR ?? 45.2}</span>
            </div>
            ...
            <div className="mt-3 grid gap-3 text-[12px]">
              <div className="relative grid h-16 grid-cols-[1fr_auto] items-center rounded-[10px] border border-[#E7EAF0] bg-[#FAFBFD] px-3">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="mt-0.5 text-[20px] font-semibold text-[#151824]">{selected?.dofollowPct ?? 78}%</div>
                </div>
              ...
              <div className="relative grid h-16 grid-cols-[1fr_auto] items-center rounded-[10px] border border-[#E7EAF0] bg-[#FAFBFD] px-3">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="mt-0.5 text-[20px] font-semibold text-[#151824]">{selected?.nofollowPct ?? 22}%</div>
                </div>
                <div className="text-right text-[11px] text-[#8D96A8]">
          ...
          <div className="rounded-[14px] border border-[#E7EAF0] bg-[var(--input)] p-4 shadow-sm">
            ...
            <ul className="mt-3 space-y-2 text-[13px]">
              <li className="flex items-center justify-between rounded-[10px] border border-[#DFF1E7] bg-[#F3FBF7] px-3 py-3">
                ...
                <span className="font-semibold text-[#2B3040] tabular-nums">{pagesScanned.toLocaleString()}</span>
              </li>
              ...
              <li className="flex items-center justify-between rounded-[10px] border border-[#FDEFCF] bg-[#FFF9EC] px-3 py-3">
                ...
                <span className="font-semibold text-[#2B3040] tabular-nums">{redirects.toLocaleString()}</span>
              </li>
              ...
              <li className="flex items-center justify-between rounded-[10px] border border-[#FFE3E3] bg-[#FFF6F6] px-3 py-3">
                ...
                <span className="font-semibold text-[#2B3040] tabular-nums">{broken.toLocaleString()}</span>
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-[14px] border border-[#E7EAF0] bg-[var(--input)] p-4 shadow-sm">
            ...
            <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div className="rounded-[12px] border border-[#EDF1F5] bg-[#FAFBFD] p-4 text-center">
                ...
                <div className="text-[22px] font-semibold leading-none text-[#151824] tabular-nums">{lcp.toFixed(1)}s</div>
              ...
              <div className="rounded-[12px] border border-[#EDF1F5] bg-[#FAFBFD] p-4 text-center">
                ...
                <div className="text-[22px] font-semibold leading-none text-[#151824] tabular-nums">{Math.round(inp)}ms</div>
        ...
        <section className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div className="rounded-[14px] border border-[#E7EAF0] bg-[var(--input)] p-4 shadow-sm">
            ...
            <div className="mt-4 space-y-2">
              {[
                ...
                return (
                  <div key={row.label} className="grid grid-cols-[88px_auto_1fr] items-center  gap-3 rounded-[10px] border border-[#ECF0F4] bg-[#FAFBFD] px-3 py-2 rounded-tr-2xl">
                    <span className="inline-flex items-center justify-center rounded-md bg-[var(--input)] px-2 py-1 text-[12px] text-[#566072]">{row.label}</span>
            ...
            <div className="mt-3 flex justify-end">
              <button type="button" className="inline-flex items-center gap-2 rounded-[10px] border border-[#DDE3ED] bg-[#FAFBFD] px-3 py-2 text-[12px] font-medium text-[#566072]">
          ...
          <div className="rounded-[14px] border border-[#E7EAF0] bg-[var(--input)] p-4 shadow-sm">
            ...
            <ul className="mt-4 space-y-3 text-[13px]">
              ...
              <li className="grid grid-cols-[1fr_auto_160px] items-center gap-3">
                <span className="flex items-center gap-2 text-[#4B5563]">
                  <span className="inline-flex h-4 w-4 items-center justify-center rounded-full border border-[#CFE1FF] bg-[#EFF5FF]"><span className="h-2 w-2 rounded-full bg-[#3B82F6]" /></span>
                  Newsletter
                </span>
          ...
          <div className="rounded-[14px] border border-[#E7EAF0] bg-[var(--input)] p-4 shadow-sm">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-between rounded-[12px] border border-[#F1F4F9] bg-[#FBFCFE] px-3 py-3">
                ...
                <span className="text-[13px] font-semibold text-[#2B3040] tabular-nums">{serpCounts[0]}</span>
              </div>
              ...
              <div className="flex items-center justify-between rounded-[12px] border border-[#F1F4F9] bg-[#FBFCFE] px-3 py-3">
                ...
                <span className="text-[13px] font-semibold text-[#2B3040] tabular-nums">{serpCounts[1]}</span>
              </div>
              ...
              <div className="flex items-center justify-between rounded-[12px] border border-[#F1F4F9] bg-[#FBFCFE] px-3 py-3">
                ...
                <span className="text-[13px] font-semibold text-[#2B3040] tabular-nums">{serpCounts[2]}</span>
              </div>
              ...
              <div className="flex items-center justify-between rounded-[12px] border border-[#F1F4F9] bg-[#FBFCFE] px-3 py-3">
                ...
                <span className="text-[13px] font-semibold text-[#2B3040] tabular-nums">{serpCounts[3]}</span>
              </div>
              ...
              <div className="flex items-center justify-between rounded-[12px] border border-[#F1F4F9] bg-[#FBFCFE] px-3 py-3">
                ...
                <span className="text-[13px] font-semibold text-[#2B3040] tabular-nums">{serpCounts[4]}</span>
              </div>
            </div>
          </div>
            ...
            <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-5">
              {[
                ...
                <div key={b.name} className="rounded-[12px] border border-[#EDF1F5] bg-[#FAFBFD] p-4 text-center">
                  ...
                  <div className="mt-1 text-[22px] font-semibold leading-none text-[#151824] tabular-nums">2<span className="text-[#6B7280]">/5</span></div>
                  <div className="mt-1 text-[11px] text-[#8D96A8]">{b.pages}</div>
                </div>
              ))}
            </div>

            <div className="mt-4 text-[12px] text-[#6B7280]">AI tool visibility and optimization scores</div>
          </div>
        </section>
          ...
          <div className="flex items-center justify-between rounded-[18px] border border-[#E7EAF0] bg-[var(--input)] px-4 py-3 shadow-sm">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="leading-tight">
                ...
                <div className="mt-0.5 text-[20px] font-extrabold leading-none text-[#0F172A] tabular-nums">{oppCounts[2]}</div>
                <div className="mt-1 text-[11px] font-medium text-[#16A34A] whitespace-nowrap">+23%<span className="text-[#6B7280]"> since last month</span></div>
              </div>
            </div>
            <button className="ml-4 inline-flex items-center gap-1 text-[11px] font-medium text-[#8D96A8] shrink-0 whitespace-nowrap">View All <ChevronRight size={12} /></button>
          </div>
          ...
          <div className="flex items-center justify-between rounded-[18px] border border-[#E7EAF0] bg-[var(--input)] px-4 py-3 shadow-sm">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="leading-tight">
                ...
                <div className="mt-0.5 text-[20px] font-extrabold leading-none text-[#0F172A] tabular-nums">{oppCounts[3]}</div>
                <div className="mt-1 text-[11px] font-medium text-[#DC2626] whitespace-nowrap">-32%<span className="text-[#6B7280]"> since last month</span></div>
              </div>
            </div>
            <button className="ml-4 inline-flex items-center gap-1 text-[11px] font-medium text-[#8D96A8] shrink-0 whitespace-nowrap">View All <ChevronRight size={12} /></button>
          </div>
        ...
        <div className="overflow-hidden rounded-[16px] border border-[#E7EAF0] bg-[var(--input)] shadow-sm">
          <div className="hidden md:grid grid-cols-[2.1fr_1.4fr_1.2fr_1.5fr_1.3fr_1fr_1fr_1.8fr] items-center px-4 py-3 text-[12px] font-semibold text-[#4B5563] bg-[#F8FAFC] text-center">
          ...
          <ul className="divide-y divide-[#ECEFF5]">
            {(seoRowsFromData ?? [
              ...
              <li key={i} className="grid grid-cols-1 md:grid-cols-[2.1fr_1.4fr_1.2fr_1.5fr_1.3fr_1fr_1fr_1.8fr] items-center gap-3 px-4 py-3 text-[13px] hover:bg-[#FAFBFD] text-center">
