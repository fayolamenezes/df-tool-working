        ...
        <div className="overflow-hidden rounded-[16px] border border-[var(--border)] bg-[var(--input)] shadow-sm">
          ...
          <ul className="divide-y divide-[#ECEFF5]">
            {(seoRowsFromData ?? [
              ...
              <li key={i} className="grid grid-cols-1 md:grid-cols-[2.1fr_1.4fr_1.2fr_1.5fr_1.3fr_1fr_1fr_1.8fr] items-center gap-3 px-4 py-3 text-[13px] hover:bg-[var(--input)] text-center">
                <div className="flex items-center gap-2 text-[var(--text)] justify-start">
                  <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[var(--input)] text-[var(--muted)]"><Wifi size={14} /></span>
                  <span className="truncate">{row.keyword}</span>
                </div>
                <div>
                  <span className="inline-flex items-center gap-1 rounded-md border border-[var(--border)] bg-[#F6F8FB] px-2 py-0.5 text-[11px] text-[var(--muted)]">
                ...
                <div className="flex justify-center"><button className="inline-flex items-center justify-center rounded-full border border-[var(--border)] bg-[var(--input)] px-4 py-1.5 text-[12px] font-semibold text-[#3178C6]">Generate</button></div>
                <div className="flex justify-center"><button className="inline-flex items-center justify-center rounded-full border border-[var(--border)] bg-[var(--input)] px-4 py-1.5 text-[12px] font-semibold text-[#3178C6]">Generate</button></div>
                <div className="flex items-center justify-center gap-3 text-[var(--muted)]">
                  <span className="inline-flex items-center gap-1 rounded-md border border-[var(--border)] bg-[#F6F8FB] px-2 py-0.5 text-[11px]">{row.preference ?? "—"}</span>
                  <span className="flex items-center gap-2 text-[var(--muted)]">
                    <ThumbsUp size={16} className="hover:text-[var(--muted)] cursor-pointer" />
                    <ThumbsDown size={16} className="hover:text-[var(--muted)] cursor-pointer" />
                  </span>
                </div>
              </li>
            ))}
